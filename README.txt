...
1 - run "python3 QM.py" on the command line to run the algorithm on its own fully on the command line.
...
2 - run the GUI to use the full program functionality, which runs the algorithm and produces a schematic of the circuit.
